...
do
  ...
  ln -s $subj_tractoflow_output_folder/Tracking_Interface/PFT_Tracking/${subjid}__filtered_20_200.trk $subj_folder/bundles/tractoflow__interface_pft_tracking_wholebrain.trk
  ln -s $subj_tractoflow_output_folder/Tracking_WM/PFT_Tracking/${subjid}__filtered_20_200.trk $subj_folder/bundles/tractoflow__wm_pft_tracking_wholebrain.trk
  ln -s $subj_tractoflow_output_folder/Tracking_WM/Local_Tracking/${subjid}__filtered_20_200.trk $subj_folder/bundles/tractoflow__wm_local_tracking_wholebrain.trk
done
