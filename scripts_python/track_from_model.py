...
def main():
    ...
    if args.input_from_hdf5:
        ...
        subject_data = load_subj_from_data(args)
    ...
    tracking_field = RecurrentTrackingField(model, subject_data, volume_group)

    logging.debug("Instantiating propagator.")
    theta = gm.math.radians(args.theta)
    propagator = RecurrentPropagator(tracking_field, args.step_size,
    ...
    tracker = DWIMLTrackerOneInputAndPD(
        ...
        max_invalid_dirs, args.compress, args.nbr_processes, args.save_seeds,
        mmap_mode, args.rng_seed, args.track_forward_only, args.use_gpu)
