...
setup(
    ...
    description='ML pipeline for the Learn2Track project',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/scil-vital/Learn2Track',

    # Author details
    author='Philippe Poulin',
    author_email='philippe.poulin2@usherbrooke.ca',
    ...
    install_requires=['numpy', 'torch', 'tqdm', 'PyYAML', 'h5py', 'scilpy'],
